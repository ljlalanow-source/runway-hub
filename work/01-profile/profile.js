...
window.PROFILE = {
  ...
  hero: {
    ...
    positioning: "",                    // 질문 2. 한 문장
    intro: "",                          // 소개 1~2줄
    keywords: [],                       // 대표 분야 키워드 (상단 왼쪽에 앞 두 개만)
    photo: ""                           // 사진 파일명. 같은 폴더에 두고 게시할 때 함께 올린다
  },

  // SECTION 2 — SELECTED WORK (질문 6, 3~5개). 홈에는 image · title · category · summary · url 만 보인다.
  work: [
  ...
  // SECTION 3 — WHAT I DO (질문 5, 4~6개). 제목만 보이고 desc는 마우스를 올리면 나타난다.
  ...
  numbers: [              // 질문 7. 앞 3개만 보인다. 실제 수치가 없으면 [] — 억지로 만들지 않는다
  ],
  about: {                // 인터뷰(질문 3·4)에서 나온 "나의 특별한 점"을 한 문장으로. 임팩트 있고 간결하게
    body: [""]
  },
  ...
  notes: {
    changed: "",          // 질문 3. 지금과 가장 크게 달라질 점
    knownFor: "",         // 질문 4. 알려지고 싶은 것
    proof: "",            // 질문 7. 받아보고 싶은 성과나 증거
    stop: ""              // 질문 8. 더 이상 하고 싶지 않은 일
  }
};
